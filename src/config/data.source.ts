...
import { Abilities } from 'src/pokemon/entities/abilities_entity';
...
import { sprites } from 'src/pokemon/entities/sprites.entity';
...
export const DataSourceConfig: DataSourceOptions = {
  ...
  entities: [Abilities, PokeAbility, PokeType, Types, PokemonInfo, sprites],
